  ...
  render() {
    ...
    return(
      <View>
        ...
        showsButtons={false}
        paginationStyle={{bottom:10, paddingTop:10, borderTopColor:"rgba(255,255,255,0)",borderTopWidth:pixel}}
        ...
        <TouchableHighlight onPress={this.handleOpen.bind(this)} style={styles.backBtn}>
          <Icon size={26} name="ios-menu-outline" style={styles.backBtnIcon}></Icon>
        </TouchableHighlight>
        <TouchableHighlight onPress={()=>alert("search")} style={styles.searchBtn}>
          <Icon size={26} name="ios-search-outline" style={styles.searchBtnIcon}></Icon>
        </TouchableHighlight>
        <TouchableHighlight onPress={()=>alert("setting")} style={styles.settingBtn}>
          <Icon size={26} name="ios-settings-outline" style={styles.settingBtnIcon}></Icon>
        </TouchableHighlight>
      </View>
    )
  }
  ...
  render() {
    return(
      <View style={styles.weatherContainer}>
        <Weather onPress={this.handleOpen.bind(this)} back={()=>this._back}></Weather>
      </View>
    )
  }
}
...
const styles = StyleSheet.create({
  ...
  withinDayHoursContainer:{
    marginTop:3,
    borderTopColor:"rgba(255,255,255,0.7)",borderTopWidth:pixel,
    borderBottomColor:"rgba(255,255,255,0.7)",borderBottomWidth:pixel
  },
  withinDayHours:{
