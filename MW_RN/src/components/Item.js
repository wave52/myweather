...
export default class Item extends Component {
  ...
  _render(){
    let {icon, iconSize, name, subName, color, first, avatar, disable, font, switchBtn} = this.props
    font = font||"Ionicons"
      ...
      <View style={styles.listItem}>
        ...
        <View style={[styles.listInfo, {borderTopWidth: !first?1:0}]}>
          ...
          <View style={styles.listInfoRight}>
            ...
            {disable||switchBtn?null:(<Font.Ionicons style={{marginLeft: 10}} name="ios-arrow-forward-outline" size={px2dp(18)} color="#bbb" />)}
            {switchBtn?<Switch onValueChange={this.props.onPress} value={this.props.isSwitchOn} onTintColor="#2095cb"/>:null}
          </View>
        </View>
      </View>
    )
